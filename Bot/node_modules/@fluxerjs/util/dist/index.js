...
__export(index_exports, {
  ...
  PermissionFlagsMap: () => PermissionFlagsMap,
  ...
  resolveTenorToImageUrl: () => resolveTenorToImageUrl,
  truncate: () => truncate
});
  ...
  if (Array.isArray(perms)) {
    ...
    for (const p of perms) {
      ...
      if (typeof p === "number") v = BigInt(p);
        ...
        v = mapped !== void 0 ? BigInt(mapped) : BigInt(Number(p) || 0);
      } else v = BigInt(p.bitfield);
      acc |= v;
    }
    return String(acc);
  }
