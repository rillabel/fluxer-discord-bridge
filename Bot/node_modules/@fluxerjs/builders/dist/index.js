...
var EmbedBuilder = class _EmbedBuilder {
  ...
  setImage(input) {
    this.data.image = input ? toEmbedMedia(input) : void 0;
    return this;
  }
  /** Set the embed thumbnail (URL string or full media options). */
  setThumbnail(input) {
    this.data.thumbnail = input ? toEmbedMedia(input) : void 0;
    return this;
  }
  /**
   ...
   */
  setVideo(input) {
    this.data.video = input ? toEmbedMedia(input) : void 0;
    return this;
  }
  /**
   ...
   */
  setAudio(input) {
    this.data.audio = input ? toEmbedMedia(input) : void 0;
    return this;
  }
  ...
  static from(data) {
    ...
    b.data.video = data.video ?? void 0;
    b.data.audio = data.audio ?? void 0;
...
var MessagePayload = class _MessagePayload {
  ...
  static create(contentOrOptions) {
    ...
    if (typeof contentOrOptions === "string") {
      ...
      if (contentOrOptions.content !== void 0)
      ...
      if (contentOrOptions.message_reference)
        payload.setReply(contentOrOptions.message_reference);
